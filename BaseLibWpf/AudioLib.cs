...
// Notes:
// If it is desired for this assembly to be CLS Compliant, then define the pragma CLS_COMPLIANT
// - to control compilation of the CLSCompliant attribute.
...
namespace Hurst.BaseLibWpf
{
    ...
    public static class AudioLib
    {
        ...
        /// <summary>
        /// Play asynchronously an audio file which is embedded into this assembly (Hurst.BaseLib) as a resource.
        ...
        /// </summary>
        /// <param name="unmanagedMemoryStream">An UnmanagedMemoryStream that refers to an embedded audio file. For example, global::Hurst.Properties.Resources.Incorrect</param>
#if CLS_COMPLIANT
        ...
        public static void PlaySoundResource(UnmanagedMemoryStream unmanagedMemoryStream)
        {
            ...
            {
                Debug.WriteLine("PlaySoundResource: Error trying to access or play the resource: " + x.Message);
            }
        }
        #endregion
        ...
        /// <summary>
        /// Play an audio file which is embedded into this assembly (Hurst.BaseLib) as a resource.
        ...
        /// </summary>
        /// <param name="unmanagedMemoryStream">An UnmanagedMemoryStream that refers to an embedded audio file. For example, global::Hurst.BaseLib.Properties.Resources.Incorrect</param>
#if CLS_COMPLIANT
        [CLSCompliantAttribute(false)]
#endif
        public static void PlaySoundResourceEvenIfNotPCM(UnmanagedMemoryStream unmanagedMemoryStream)
        {
            ...
            {
                Debug.WriteLine("PlaySoundResourceEvenIfNotPCM: Error trying to access or play the resource: " + x.Message);
            }
        }
        #endregion
